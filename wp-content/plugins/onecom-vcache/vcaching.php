...
class VCachingOC {
    ...
    public function purge_varnish_cache_all_adminbar($admin_bar)
    {
        $admin_bar->add_menu(array(
            ...
            'title' => '<span class="ab-icon dashicons dashicons-trash"></span>' . __('Purge one.com cache', $this->plugin),
            'href'  => wp_nonce_url(add_query_arg($this->purgeCache, 'cdn'), $this->plugin),
            'meta'  => array(
                'title' => __('Purge one.com cache', $this->plugin),
            )
        ));
        ...
        $admin_bar->add_menu(array(
            ...
            'parent' => 'purge-all-varnish-cache',
            'title' =>  __('Purge CDN', $this->plugin),
            'href'  => wp_nonce_url(add_query_arg($this->purgeCache, 'cdn'), $this->plugin),
            'meta'  => array(
                'title' => __('Purge CDN', $this->plugin),
            )
