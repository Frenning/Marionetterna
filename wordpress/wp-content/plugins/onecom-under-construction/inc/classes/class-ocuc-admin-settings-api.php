...
class OCUC_Admin_Settings_API
{
	...
	public function init(){
		...
		$this->premium_inline_msg = apply_filters('onecom_premium_inline_badge', '', __("Premium feature", ONECOM_UC_TEXT_DOMAIN), 'mwp');
	}
	...
	public function get_field_description($args)
	{
		...
		if (
			...
			$desc = sprintf('<p class="description"><span>%s</span> %s</p>', $args['desc'], $this->premium_inline_msg);
