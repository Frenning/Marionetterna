...
class Onecom_Error_Page {
	...
	public function error_page_callback() {
        ...
        <div class="wrap" id="onecom-ui">
			...
			?>
            <h1 class="one-title"> <span><?php echo __( "Advanced Error Page", OC_TEXTDOMAIN ); ?> </h1>
            <div class="page-subtitle">
				<?php echo __( "Display useful information if there is a problem on your site. This information will be visible only to the admin users.", OC_TEXTDOMAIN ); ?>
            </div>
